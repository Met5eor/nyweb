  ...
  <div class="page_wrap" ref="page_wrap">
    <div class="main">
      <div class="stc sct1 u-fx-ver u-fx-ac">
        <img
          class="sct_img img1"
          src="https://cdn.upchina.com/front/20211209shareVip/wx/wximg/h5_img1 (1).png"
          alt=""
        />
      ...
      <div class="stc sct7 u-fx-ac-jc bg">
        ...
        />
        <div class="cont">
          <p class="row1 row">1、活动时间：2022.01.01-2022.01.07</p>
      ...
      <div class="footer none" v-if="isFooter">
        <img
          ...
          src="https://cdn.upchina.com/front/20211209shareVip/wx/wximg/h5_footer (1).png"
          alt=""
        />
...
import { appCheckLogin, appLogin } from "@u/login";
...
export default {
  ...
  async created() {
    ...
    if (uid === "wx_160625120079270971" || uid === "up2826668")
      return this.$router.push("/inviteFriends");
  },
  mounted() {
    this.initPage();
  },
...
.page_wrap {
  ...
  .main {
    width: 100%;
    background: #d41423
      url("https://cdn.upchina.com/front/20211209shareVip/wx/wximg/h5_head_bg.jpg")
      no-repeat;
    background-size: 100%;
    // height: 10rem;
    // padding: 0 0.2rem;
