<template>
  <div class="page_wrap" ref="page_wrap">
    <div class="main">
      <div class="stc sct1">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/head.png" alt="" />
      ...
      <div class="stc sct2 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img2.png" alt="" />
      </div>

      <div class="stc sct3 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img3.png" alt="" />
      </div>

      <div class="stc sct4 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img4.png" alt="" />
      </div>

      <div class="stc sct5 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img5.png" alt="" />
      </div>

      <div class="stc sct6 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img6.png" alt="" />
      </div>

      <div class="stc sct7 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img7.png" alt="" />
      </div>

      <div class="stc sct8 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img8.png" alt="" />
      </div>

      <div class="stc sct9 u-fx-ac-jc">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img9.png" alt="" />
      </div>

      <div class="stc sct10 u-fx-ac-jc" :class="isFooter?'mar-b6':''">
        <img class="sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/img10.png" alt="" />
      </div>

      <div class="footer none" v-if="isFooter">
        <img class="footer_img sct_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5/footer.png" alt="" />
    ...
    >
      <div class="pop popod">
        <img class="pop_img" src="https://cdn.upchina.com/front/20211207map/weixin/img/h5_mask.png" alt="" />
...
export default {
  ...
  data() {
    return {
      stc1SwiperUrls: [
        {
          img: "https://cdn.upchina.com/front/20211207map/weixin/img/h5/swiper1.png",
        },
        {
          img: "https://cdn.upchina.com/front/20211207map/weixin/img/h5/swiper2.png",
        },
        {
          img: "https://cdn.upchina.com/front/20211207map/weixin/img/h5/swiper3.png",
        },
        {
          img: "https://cdn.upchina.com/front/20211207map/weixin/img/h5/swiper4.png",
        },
      ],
      showOrdermMak: false,
      isFooter: false,
