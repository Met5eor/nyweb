...
<template>
    <div class="box">
        <div class="header">
            <img src="../../assets/images/518activity/header-pc.png" alt="财运大转盘"/>
        </div>
        <div class="content">
            <div class="activity">
                <div class="title">
            ...
            <div class="activity">
                 <div class="title">
                    ...
                    <div class="tips" style="cursor:pointer;text-decoration: underline;" @click="showMyPizePool">我的奖品池</div>
                </div>
                <div class="cont">
            ...
            <div class="activity-tips">
                <h1>活动说明</h1>
                <p>1、活动时间:2021年5月18日-5月21日23:59  共4天</p>
            ...
            <el-dialog :visible.sync="lottBefore" :lock-scroll="false" custom-class="dialog tx" width="680px" :show-close="false">
                <!-- "有趣"的抽奖  0.0 -->
                <img :src="lottImg" @click="lotteryFn">
            </el-dialog>
            <!-- 抽奖弹窗 -->
            <Lottery ref="lottBefore" @changeLott="(v)=>{lottBefore=false}"/>
        </div>
        <div class="lotter-load" v-if="actStatus!==-2">
            <img @click="lotteryFn" :src="require('../../assets/images/lotter.gif')">
        </div>
        <!-- <div class="footer">
            <img src="../../assets/images/518activity/footer-pc.png" alt="518试试手气"/>
        </div> -->
    </div>
</template>
...
export default {
  ...
  methods:{
    ...
    // 显示我的奖品池
    showMyPizePool(){
        const ref = this.$refs.lottBefore;
        if(ref){
            ref.getShowPool();
        }
    },
